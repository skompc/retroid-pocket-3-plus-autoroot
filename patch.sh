...
PYTHON_LOC=~/anaconda3/bin/python3

echo "Extracting keys from vbmeta"
$PYTHON_LOC extract.py vbmeta.img

echo "Creating custom key for boot"
$PYTHON_LOC avbtool.py extract_public_key --key custom.pem --output custom.bin
